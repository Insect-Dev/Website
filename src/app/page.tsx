...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-start space-y-10 bg-white dark:bg-zinc-900 dark:text-white">
      <div className="flex items-center justify-between h-16 w-full bg-zinc-950 p-5">
